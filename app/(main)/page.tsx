      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-accent via-accent/50 to-background py-24 md:py-32 lg:py-40">
        ...
        <div className="container relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-bold font-heading tracking-tight mb-6">
              Пронајди го <span className="text-primary">Твојот нов дом</span>
            </h1>
